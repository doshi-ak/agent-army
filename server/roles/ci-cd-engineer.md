...
model: haiku
provenance: agent-superteam/agents/03-infrastructure/deployment-engineer.md (upstream VoltAgent + wshobson (identical in both), MIT; copied verbatim 2026-07-11)
---
